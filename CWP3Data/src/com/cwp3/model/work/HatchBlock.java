...
public class HatchBlock {
    ...
    private Map<Integer, VMHatchCover> hatchCoverMap; //舱盖板对象，主键为舱盖板陆侧到海侧顺序
...
//            List<Integer> hcSeqList = new ArrayList<>(aboveBlockMap.keySet());
//            if (hcSeqList.size() == 1) {
//                return hcSeqList.get(0);
//            } else {
//                int rowNo = rowNo1;
//                while (!aboveBlockMap.get(hcSeqList.get(0)).contains(rowNo)) {
//                    rowNo -= 2;
//                    if (aboveBlockMap.get(hcSeqList.get(0)).contains(rowNo)) {
//                        return hcSeqList.get(0);
//                    }
//                    if (rowNo < 0) {
//                        break;
...
//                }
//                rowNo = rowNo1;
//                while (!aboveBlockMap.get(hcSeqList.get(hcSeqList.size() - 1)).contains(rowNo)) {
//                    rowNo -= 2;
//                    if (aboveBlockMap.get(hcSeqList.get(hcSeqList.size() - 1)).contains(rowNo)) {
...
//            List<Integer> hcSeqList = new ArrayList<>(belowBlockMap.keySet());
//            if (hcSeqList.size() == 1) {
//                return hcSeqList.get(0);
//            } else {
//                int rowNo = rowNo1;
//                while (!belowBlockMap.get(hcSeqList.get(0)).contains(rowNo)) {
//                    rowNo -= 2;
//                    if (belowBlockMap.get(hcSeqList.get(0)).contains(rowNo)) {
//                        return hcSeqList.get(0);
//                    }
//                    if (rowNo < 0) {
//                        break;
...
//                }
//                rowNo = rowNo1;
//                while (!belowBlockMap.get(hcSeqList.get(hcSeqList.size() - 1)).contains(rowNo)) {
//                    rowNo -= 2;
//                    if (belowBlockMap.get(hcSeqList.get(hcSeqList.size() - 1)).contains(rowNo)) {
//                        return hcSeqList.get(hcSeqList.size() - 1);
//                    }
//                    if (rowNo < 0) {
//                        break;
